...
public class AuthService {
    ...
    public LoginVO login(LoginRequest request) {
        ...
        return new LoginVO(token, user.getUsername(), user.getNickname(), role, jwtUtil.getExpireSeconds());
    }
    ...
    public LoginVO current(String userId) {
        ...
        return new LoginVO(null, user.getUsername(), user.getNickname(), role, jwtUtil.getExpireSeconds());
    }
}
